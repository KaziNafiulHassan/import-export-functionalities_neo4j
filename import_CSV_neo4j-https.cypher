...
LOAD CSV WITH HEADERS FROM $file_0 AS line
...
// Load Site Nodes
LOAD CSV WITH HEADERS FROM $file_1 AS line
...
LOAD CSV WITH HEADERS FROM $file_1 AS line2
...
LOAD CSV WITH HEADERS FROM $file_1 AS line3
...
LOAD CSV WITH HEADERS FROM $file_2 AS line4
...
LOAD CSV WITH HEADERS FROM $file_2 AS line5
